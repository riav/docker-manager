...
LABEL docker.manager.version="0.1.1" docker.manager.volumes=":/var/run/docker.sock :/docker-manager.cfg" docker.manager.env="DOCKER_SOCK=/var/run/docker.sock" docker.manager.jq="1.5" docker.manager.from="alpine"
